	...
	<div id="home-container">
		<div id="most-visited-product" >
			<h1 class="home-title" style="line-height: 1em;" >
				product<br><span style="font-size: 10px;line-height: 1em;"> (most visited)</span>
			</h1>
		...
		<div id="most-recent-product" >
			<h1 class="home-title" style="line-height: 1em;" >
				product<br><span style="font-size: 10px;line-height: 1em;"> (most recent)</span>
			</h1>
		...
		<div id="most-recent-news">
			<h1 class="recent-news-title" style="line-height: 1em;" >
				News<br><span style="font-size: 10px;line-height: 1em;"> (most recent)</span>
			</h1>
...
$(document).ready(function(){
	window.document.title = "<?php echo $sitetitle." | "; ?>Home";
