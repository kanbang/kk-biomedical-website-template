...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
	<head>
		...
		$kwquery = mysql_query("SELECT name FROM productbykk_de WHERE state = 1 ORDER BY id  DESC ;", $db);
		if (!$kwquery)
	...
	<body>
			...
			<div id="login-form" >
				...
				<form action="?login=1" method="POST" >
					<div style="padding: 5px 5%;">
						<div style="width: 100%;color: #555;margin: 0 0 2px 0;">E-Mail oder Handy</div>
						<input type="text"  style="width: 258px;" class="textbykk" name="lemail" >
					</div>
					<div style="padding: 5px 5%;">
						<div style="width: 100%;color: #555;margin: 0 0 2px 0;">Kennwort</div>
						<input type="password"  style="width: 258px;" class="textbykk" name="lpassword" >
					</div>
					<div style="padding: 5px 5%;">
						<div style="width: 100%;color: #555;margin: 0 0 2px 0;"><input type="checkbox" style="float: left;margin: 5px;" name="rememberme" ><div style="margin: 3px;float: left;">Mich Erinnern</div></div>
						<input type="submit" value="Anmelden" style="width: 268px;" class="btnbykk" >
		...
		<div id="toolbar" >
			<div class="inner" >
				<div id="lang" >
					...
					<span class="selected" ><a href="../de/" class="download" >[De]</a></span>
					<span ><a href="../en/" class="download" >[En]</a></span>
				</div>
				...
				{
				?>
					<div id="login-pop-up" class="login">Amelden</div>
					<div id="signup-pop-up" class="signup">Eintragen</div>
				<?php 
				}
				else
				{
				?>
					<div class="logout" ><a href="?logout=1" style="color:#ccc;" class="download" >Ausloggen</a></div>
					<div  class="profile" id="profile-pop-up">Profil [<?php if(isset($_SESSION["adminbykk"])) echo $_SESSION["adminbykk"][1]; else echo $_SESSION["userbykk"][1]; ?>]</div>
				<?php 
				}
				?>
				</div>
		...
		<div id="navbar" >
				...
				<ul id="menu" >
					...
					<li>
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/news.php"); ?>" class="item news" >
							<span class="primary" >
								<span class="title" >News / Artikel</span>
							</span>
						</a>
					</li>
					<li>
			...
			<div id="sub-menu">
				...
				<div class="sub-menus product">
					<span class="title product" >Produktkategorie</span>
					<div class="container" >
			...
			<div style="height: 210px;width: 980px;margin: 0 auto;position: relative;">
				...
				<div style="height: 100px;width: 300px;float: left;">
					<div class="footer-link">
						<a href="?cmode=home&command=<?php echo encodeURIComponent("index/home.php"); ?>" onclick="gotoPage('main',500,'index/home.php');" >Startseite</a>
					</div>
					<div class="footer-link">
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/product.php"); ?>" onclick="gotoPage('full',500,'index/product.php');" >Produkte</a>
					</div>
					<div class="footer-link">
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/news.php"); ?>" onclick="gotoPage('full',500,'index/news.php');" >News / Artikel</a>
					</div>
					<div class="footer-link">
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/gallery.php"); ?>" onclick="gotoPage('full',500,'index/gallery.php');" >Galerie</a>
					</div>
					<div class="footer-link">
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/about.php"); ?>" onclick="gotoPage('full',500,'index/about.php');" >Über</a>
					</div>
					<div class="footer-link">
						<a href="?cmode=full&command=<?php echo encodeURIComponent("index/contact.php"); ?>" onclick="gotoPage('full',500,'index/contact.php');" >Kontakt</a>
					</div>
				</div>
		...
		$(document).ready(function(){
			...
			History.pushState({number:pageNumber}, 'Startseite', "?PH="+pageNumber);
