...
//include 'jdf.php';
function visiting($pname,$db,$sitelang='de')
{
	//$date = jdate('F Y');
	$date = date('F Y');
	$do = "p".$pname;
...
else if($page == 'product')
{
	...
	else if(isset($_GET["category"]) || isset($_GET["sub_category"]))
	{
		...
		?>
			...
			?>
		<script>
		window.document.title= "<?php echo $sitetitle." | "; ?>Produkte";
		disableATag();
		</script>
		<?php
	}
...
else if($page == 'news')
{
	...
	if(isset($_GET["id"]))
	{
		...
		if($row = mysql_fetch_row($query))
		{
			?>
			<span class="pn-spacer" >&gt;</span>
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/news.php"); ?>" onclick="gotoPage('full',500,'index/news.php');" >News / Artikel</a></span>
			<span class="pn-spacer" >&gt;</span>
	...
	else
	{
		?>
			...
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/news.php"); ?>" onclick="gotoPage('full',500,'index/news.php');" >News / Artikel</a></span>
		<script>
		window.document.title= "<?php echo $sitetitle." | "; ?>News / Artikel";
		disableATag();
		</script>
		<?php
...
else if($page == 'gallery')
{
	...
	if(isset($_GET["id"]))
	{
		...
		?>
			<span class="pn-spacer" >&gt;</span>
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/gallery.php"); ?>" onclick="gotoPage('full',500,'index/gallery.php');" >Galerie</a></span>
			<span class="pn-spacer" >&gt;</span>
	...
	else
	{
		?>
			...
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/gallery.php"); ?>" onclick="gotoPage('full',500,'index/gallery.php');" >Galerie</a></span>
		<script>
		window.document.title= "<?php echo $sitetitle." | "; ?>Galerie";
		disableATag();
		</script>
		<?php
...
else if($page == 'about')
{
	...
	if(isset($_GET["id"]))
	{
		...
		if($row = mysql_fetch_row($query))
		{
			?>
			<span class="pn-spacer" >&gt;</span>
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/about.php"); ?>" onclick="gotoPage('full',500,'index/about.php');" >Über</a></span>
			<span class="pn-spacer" >&gt;</span>
	...
	else
	{
		?>
			...
			<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/about.php"); ?>" onclick="gotoPage('full',500,'index/about.php');" >Über</a></span>
		<script>
		window.document.title= "<?php echo $sitetitle." | "; ?>Über";
		disableATag();
		</script>
		<?php
...
else if($page == 'contact')
{
	...
	?>
		<span class="pn-spacer" >&gt;</span>
		<span class="pn-item" ><a href="?cmode=full&command=<?php echo encodeURIComponent("index/contact.php"); ?>" onclick="gotoPage('full',500,'index/contact.php');" >Kontakt</a></span>
	<script>
	window.document.title= "<?php echo $sitetitle." | "; ?>Kontakt";
	disableATag();
	</script>
	<?php
}
