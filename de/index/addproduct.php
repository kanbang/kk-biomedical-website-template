...
if($isAdmin)
{
	...
	else if($_GET["mode"] == 'edit' || $_GET["mode"] == 'applyedit')
	{
		...
		function subcheck(category,subcategory)
		{
			...
			$('#sub_category_ajax').load('index/productsubcategory.php?ajax=1&psclang=de&selectedcategory='+encodeCategory+'&selectedsubcategory='+encodeSubcategory);
		...
		{
			var cropCommand = "";
			cropCommand = "&mode=product&lang=de&id="+id;
