...
?>
	...
	<div id="album-image-container" class="gad-gallery" style="position: absolute;top:10px;left:10px;right: 10px;bottom:10px;">
		...
		$("#controlpanel_container .controls").empty().css({'opacity':'0.0'}).append(
			"<div class='btn add' onclick='addGallery();' title='افزودن عکس/گالری' ></div><div class='btn change' onclick=editAlbum('<?php echo $album; ?>'); title='تغییر آلبوم' ></div><div class='btn delete' onclick=deleteThisAlbum('<?php echo $album; ?>'); title='حذف تمام آلبوم' ></div>"
...
<?php 
	...
	{
	?>
	<div id="delete_dialogG" title="حذف عکس" style="display: none;">
	<span class="ui-icon ui-icon-alert" style="float:right; margin:0 0 20px 7px;"></span>مطمئن هستید؟
	</div>
	<div id="delete_dialogA" title="حدف آلبوم" style="display: none;">
	<span class="ui-icon ui-icon-alert" style="float:right; margin:0 0 20px 7px;"></span>مطمئن هستید؟
	</div>
	<?php 
	}
...
$("#controlpanel_container .controls").empty().css({'opacity':'0.0'}).append(
	"<div class='btn add' onclick='addGallery();' title='افزودن عکس/آلبوم' ></div>"
	).animate({'opacity':'1'},300);
$(function() {
