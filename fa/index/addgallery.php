...
if($isAdmin)
{
	if($_GET["mode"] == 'add')
	{
		...
		{*/
			...
			<div style="font-size: 13px;color: #333;padding: 20px 5px;font-weight: bold;float:right;">تعداد<?php echo $donePictures." از ".$allPictures; ?> تصویر اضافه شد!</div>
			<script>
			setTimeout(function(){
	...
	else if($_GET["mode"] == 'edit_gallery' || $_GET["mode"] == 'applyedit_gallery')
	{
		...
		$("#controlpanel_container .controls").empty().css({'opacity':'0.0'}).append(
				"<div class='btn add' onclick='addGallery();' title='افزودن عکس/گالری' ></div><div class='btn change' onclick=editGallery('<?php echo $id; ?>'); title='تغییر عکس' ></div><div class='btn delete' onclick=deleteGallery('<?php echo $id; ?>'); title='حذف عکس!' ></div>"
				).animate({'opacity':'1'},300);
		</script>
		<div style="width: 100%;height: 100%;overflow: hidden;" id="addgallery-container">
			<div class="div-title">تغییر عکس</div>
			<form action="index/addgallery.php?mode=applyedit_gallery" method="POST" enctype="multipart/form-data" id="addgallery_form" >
				...
				<div class="div-row">
					<div class="input-div" style="width: 700px;" >
						<div class="lable" ><span class="red" >*</span>آلبوم</div>
				...
				<div class="div-row" >
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>تصویر</div>
				...
				<div class="div-row">
					<div class="input-div" >
						<div class="lable" >عنوان تصویر</div>
	...
	else if($_GET["mode"] == 'edit_album' || $_GET["mode"] == 'applyedit_album')
	{
		...
		<div style="width: 100%;height: 100%;overflow: hidden;" id="addgallery-container">
			<div class="div-title">تغییر آلبوم</div>
			<form action="index/addgallery.php?mode=applyedit_album" method="POST" enctype="multipart/form-data" id="addgallery_form" >
				...
				<div class="div-row" >
					...
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>قابلیت نمایش</div>
						<select class="textbykk" name="showto" id="showto" style="width: 412px;" >
							<option value="1" <?php if($grow[9] == 1) echo "selected";?> >همه</option>
							<option value="2" <?php if($grow[9] == 2) echo "selected";?> >اعضا</option>
							<option value="3" <?php if($grow[9] == 3) echo "selected";?> >اعضای سطح 1</option>
							<option value="4" <?php if($grow[9] == 4) echo "selected";?> >اعضای سطح 2</option>
							<option value="5" <?php if($grow[9] == 5) echo "selected";?> >اعضای سطح 3</option>
							<option value="0" <?php if($grow[9] == 0) echo "selected";?> >فقط مدیر</option>
						</select>
					</div>
				</div>
				<div class="div-row">
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>کاور 1</div>
					...
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>کاور 2</div>
				...
				<div class="div-row">
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>کاور 3</div>
	...
	$("#page-nav").css({'opacity':'0'}).empty().load('index/pagenavigator.php?page=addgallery', function() {
		...
		<div style="width: 100%;height: 100%;overflow: hidden;" id="addgallery-container">
			<div class="div-title">افزودن عکس/گالری</div>
			<form action="index/addgallery.php?mode=add" method="POST" enctype="multipart/form-data" id="addgallery_form" >
				...
				<div class="div-row" >
					<div class="input-div" >
						<div class="lable" ><span class="red" >*</span>عکس ها(امکان آپلود بشتر از یک عکس!)</div>
						<input type="file" class="textbykk" id="picture" name="picture[]" style="width: 400px;" multiple="multiple" >
					</div>
				</div>
				<div class="div-row">
					<div class="input-div" >
						<div class="lable" >عنوان عکس</div>
					...
					<div class="input-div" >
						...
						<select class="textbykk" name="showto" id="showto" style="width: 412px;" >
							...
							<option value="3" >اعضا سطح 1</option>
