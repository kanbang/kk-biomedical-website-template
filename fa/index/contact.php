...
if(($_GET["mode"] == 'edit' || $_GET["mode"] == 'applyedit' )&& $isAdmin)
{
	if($_GET["mode"] == 'applyedit')
	{
		...
		*/
		...
		<div style="font-size: 15px;color: #333;padding: 20px 5px;font-weight: bold;float:right;">اعمال تغییرات!</div>
		</div>
...
<div style="opacity:0;width: 100%;height: 100%;" id="index-loader">
	...
	<form action="index/contact.php?mode=applyedit" method="POST" enctype="multipart/form-data" id="changecontact_form" >
		<div class="div-row" >
			<div class="input-div">
				<div class="lable" >تصویر بالایی</div>
		...
		<div class="div-row" >
			<div class="input-div" style="width: 845px;" >
				<div class="labl" >متن تماس با ما</div>
...
else if($_GET["mode"] == 'addmsg')
{
	...
	if($captcha == $_SESSION['security_number'])
	{
		...
		{
			?>
			<div class='register-alert green' >پیام شما ارسال شد!</div>
			<script>
		...
		{
			?>
			<div class='register-alert red' >پیام شما ارسال نشد!</div>
			<script>
			$(".register-alert").click(function(){
			   	$(".register-alert").stop().animate({'opacity':'0'},300,function(){
			      	$(".register-alert").css({'display':'none'});
	...
	{
	?>
	<div class='register-alert red' >کد امنیتی اشتباه است</div>
	<script>
	$(".register-alert").click(function(){
	   	$(".register-alert").stop().animate({'opacity':'0'},300,function(){
	      	$(".register-alert").css({'display':'none'});
...
<div style="opacity:0;width: 100%;height: 100%;" id="index-loader">
	...
	<div style="width: 65%;margin: 20px 17.5%;border: 1px solid #bbb;position: relative;padding: 20px 0;" id="msg-container">
		<div style="top: 0px;right: 0px;position: absolute;color: #eee;background-color: #bbb;padding: 2px 5px;">پیام</div>
		...
		<form action="index/contact.php?mode=addmsg" method="POST" id="message_form" >
			...
			<div class="div-row">
				<div class="input-div">
					<div class="lable" ><span class="red" >*</span>نام</div>
				...
				<div class="input-div">
					<div class="lable" ><span class="red" >*</span>ایمیل</div>
			...
			<div class="div-row" style="height: 150px;">
				<div class="input-div" style="width: 700px;height:120px;">
					<textarea class="textbykk" style="height: 120px;width:530px;font-family: tahoma;font-size: 13px;color: #333;" name="message" onfocus="if(this.value == 'پیام شما...' )this.value='';" >پیام شما...</textarea>
				</div>
			</div>
			<div class="div-row" >
				...
				<div class="input-div">
					<div class="lable">&nbsp;</div>
					<input type="submit" value="ارسال" style="width: 250px;" class="btnbykk" >
				</div>
			</div>
		</form>
		<script type="text/javascript">
