...
if($_GET["mode"] == 'recoverpass')
{
	...
	if($row = mysql_fetch_row($query))
	{
		...
		else
		{
			...
			{
			?>
			<img alt="correct" src="../images/correct.png" style="float: left;position: relative;height: 60px;"/><br/>
			رمز جدید به ایمیل شما ارسال شد.
			<?php
			}
		}
